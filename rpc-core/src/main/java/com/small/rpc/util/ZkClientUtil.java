...
public class ZkClientUtil {
    ...
    public ZkClientUtil(String zkaddress, String zkpath, String zkdigest, Watcher watcher) {
        ...
        if (this.watcher == null) {
            ...
            this.watcher = new Watcher() {
                ...
                public void process(WatchedEvent watchedEvent) {
                    logger.info(">>>>>>>>>>> small-rpc: watcher:{}", watchedEvent);
    ...
    public ZooKeeper getClient() {
                ...
                if (INSTANCE_INIT_LOCK.tryLock(2, TimeUnit.SECONDS)) {
                    ...
                    try {
                        if (zooKeeper == null) {        // 二次校验，防止并发创建client
                            ...
                            zooKeeper = newZk;
                            logger.info(">>>>>>>>>>> small-rpc, ZkClient init success.");
                        }
                    } catch (Exception e) {
        ...
        if (zooKeeper == null) {
            throw new RpcException("ZkClient.zooKeeper is null.");
        }
        return zooKeeper;
    }
    ...
    public String getPathData(String path, boolean watch) {
        try {
            ...
            if (stat != null) {
                ...
                logger.info(">>>>>>>>>>> small-rpc, path[{}] not found.", path);
            }
            return znodeValue;
        } catch (Exception e) {
            throw new RpcException(e);
